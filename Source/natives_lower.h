...
public:
    ...
    static void set_player_model( Player * Model, Player model )
    {
        invoke< Void >( 0x00A1CADD00108836 , Model , Model );
    }
    ...
    {
        static tGET_PLAYER_NAME oGET_PLAYER_NAME = (tGET_PLAYER_NAME)(Memory::pattern("40 53 48 83 EC 20 80 3D ? ? ? ? ? 8B D9 74 22").count(1).get(0).get<void>(0));
        return oGET_PLAYER_NAME(player);
    }
    ...
    typedef int(__fastcall* tGET_PLAYER_WANTED_LEVEL)(Player player);
    static int get_player_wanted_level(Player player)
    {
        static tGET_PLAYER_WANTED_LEVEL oGET_PLAYER_WANTED_LEVEL = (tGET_PLAYER_WANTED_LEVEL)(Memory::pattern("40 53 48 83 EC 20 33 DB 38 1D ? ? ? ? 74 1C").count(1).get(0).get<void>(0));
        return oGET_PLAYER_WANTED_LEVEL(player);
    }
...
public:
    ...
    typedef int(__fastcall* tGET_ENTITY_ATTACHED_TO)(Player player);
    static Entity get_entity_attached_to(Entity entity)
    {
        static tGET_ENTITY_ATTACHED_TO oGET_ENTITY_ATTACHED_TO = (tGET_ENTITY_ATTACHED_TO)(Memory::pattern("40 53 48 83 EC 20 E8 ? ? ? ? 48 8B D8 48 85 C0 74 19 4C 8B 00 8B 15 ? ? ? ? 48 8B C8 41 FF 50 08 84 C0 74 05 48 8B C3 EB 02 33 C0 48 83 C4 20 5B C3 40 53 48 83 EC 20 E8 ? ? ? ? 48 8B D8").count(1).get(0).get<void>());
    ...
    static void attach_entity_to_entity( Entity entity1, Entity entity2, int boneIndex, float xPos, float yPos,
                                         float zPos,
                                         float xRot, float yRot, float zRot, BOOL p9, BOOL useSoftPinning,
                                         BOOL collision,
...
public:
    ...
    static void set_ped_head_blend_data( Ped ped, int shapeFirstID, int shapeSecondID, int shapeThirdID,
                                         int skinFirstID,
                                         int skinSecondID, int skinThirdID, float shapeMix, float skinMix,
                                         float thirdMix,
                                         BOOL isParent )
    {
...
{
public:
    typedef int(__fastcall* tCREATE_VEHICLE)(Hash model, Vector3 pos, float heading, BOOL networked, BOOL unk2);
    static Vehicle create_vehicle( Hash model, Vector3 pos, float heading, BOOL networked, BOOL unk2 )
    {
        static auto oCREATE_VEHICLE = tCREATE_VEHICLE(
            Memory::pattern( "48 89 5C 24 ? 55 56 57 41 54 41 55 41 56 41 57 48 8B EC 48 83 EC 50 F3 0F 10 02" )
            . count( 1 ) . get( 0 ) . get< void >( ) );
        return oCREATE_VEHICLE(model, pos, heading, networked, unk2);
    }
    ...
    static int get_vehicle_number_plate_text_index( Vehicle elegy )
    {
        return invoke< int >( 0xF11BC2DD9A3E7195 , elegy );
    }
    ...
    static Vehicle get_random_vehicle_back_bumper_in_sphere( float p0, float p1, float p2, float p3, int p4, int p5,
                                                             int p6 )
    {
    ...
    {
        return invoke< BOOL >( 0x91D6DD290888CBAB );
...
public:
    ...
    static void task_go_to_coord_any_means_extra_params_with_cruise_speed(
        Ped ped, float x, float y, float z, float speed,
    ...
    static void task_plane_mission( Ped pilot, Vehicle aircraft, Vehicle targetVehicle, Ped targetPed,
                                    float destinationX,
                                    float destinationY, float destinationZ, int missionFlag, float angularDrag,
                                    float unk,
    ...
    static void task_go_to_coord_while_aiming_at_entity( Any p0, float p1, float p2, float p3, Any p4, float p5,
                                                         BOOL p6,
                                                         float p7, float p8, BOOL p9, Any p10, BOOL p11, Any p12,
                                                         Any p13 )
    {
...
public:
    ...
    static BOOL _0xb335f761606db47c( Any * p1, Any p2, BOOL p3 )
    {
        return invoke< BOOL >( 0xB335F761606DB47C , p1 , p1 , p2 , p3 );
    }
    // 0xB335F761606DB47C 
    ...
    static float
    tan( float p0 ) { return invoke< float >( 0x632106CC96E82E91 , p0 ); } // 0x632106CC96E82E91 0xD320CE5E 
    static float
    ...
    {
        return invoke< int >( 0x4C9296CBCD1B971E );
    ...
    {
        return invoke< BOOL >( 0x6FDDF453C0C756EC );
...
public:
    ...
    {
        return invoke< BOOL >( 0x109697E2FFBAC8A1 );
...
public:
    ...
    {
        return invoke< BOOL >( 0x5EDEF0CF8C1DAB3C );
...
public:
    ...
    {
        return invoke< BOOL >( 0x74BD83EA840F6BC9 );
    ...
    {
        return invoke< BOOL >( 0xCA9D2AA3E326D720 );
...
public:
    ...
    static BOOL has_named_ptfx_asset_loaded( char * assetName )
    {
...
public:
    ...
    {
        return invoke< BOOL >( 0x4A9923385BDB9DAD );
    ...
    {
        return invoke< BOOL >( 0x4167EFE0527D706E );
...
public:
    ...
    {
        return invoke< int >( 0x473151EBC762C6DA );
    ...
    static void draw_marker( int type, float posX, float posY, float posZ, float dirX, float dirY, float dirZ,
                             float rotX,
                             float rotY, float rotZ, float scaleX, float scaleY, float scaleZ, int red, int green,
                             int blue,
                             ...
                             char * textureName, BOOL drawOnEnts )
    {
        invoke< Void >( 0x28477EC23D892089 , type , posX , posY , posZ , dirX , dirY , dirZ , rotX , rotY , rotZ ,
                        ...
                        red , green , blue , alpha , bobUpAndDown , faceCamera , p19 , rotate , textureDict ,
    ...
    // 0x873C9F3104101DD3 
    static float
    _get_aspect_ratio( BOOL b ) { return invoke< float >( 0xF1307EF624A80D87 , b ); } // 0xF1307EF624A80D87 
    ...
    static void _call_scaleform_movie_function_mixed_params( int scaleform, char * functionName, float floatParam1,
                                                             ...
                                                             char * stringParam2,
                                                             char * stringParam3, char * stringParam4,
                                                             char * stringParam5 )
    {
    ...
    {
        return invoke< BOOL >( 0xD3A10FC7FD8D98CD );
...
public:
    ...
    {
        return invoke< BOOL >( 0xECB41AC6AB754401 );
...
{
public:
    static void create_mobile_phone( Ped * p3 )
    {
        invoke< Void >( 0xA4E8E696C532FBC7 , p3 );
...
public:
    ...
    static BOOL get_nth_closest_vehicle_node_with_heading( float x, float y, float z, int nthClosest,
                                                           Vector3 * outPosition,
                                                           float * heading, Any * unknown1, int unknown2,
                                                           float unknown3,
                                                           float unknown4 )
    {
...
namespace network
{
    ...
    static void _network_voice_connect_to_player( Any * globalPtr )
    {
    ...
    {
        return invoke< BOOL >( 0x855BC38818F6F684 );
    ...
    {
        return invoke< BOOL >( 0xEF0912DDF7C4CB4B );
    ...
    {
        return invoke< BOOL >( 0x966C2BC2A7FE3F30 );
    ...
    {
        return invoke< BOOL >( 0x6EA101606F6E4D81 );
    ...
    {
        invoke< Void >( 0x407091CF6037118E , netID );
    } // 0x407091CF6037118E 
...
namespace dlc2
{
    ...
    {
        return invoke< BOOL >( 0xF2E07819EF1A5289 );
    ...
    {
        return invoke< BOOL >( 0x8D30F648014A92B5 );
...
namespace decorator
{
    ...
    {
        static tDECOR_REGISTER oDECOR_REGISTER = (tDECOR_REGISTER)(Memory::pattern("40 53 48 83 EC 20 80 3D ? ? ? ? ? 8B DA 75 29").count(1).get(0).get<void>(0));
        return oDECOR_REGISTER(propertyName, type);
    }
